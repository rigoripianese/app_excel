...
with open('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/levante/giocatori.txt', 'r') as f:
...
for giocatore in giocatori:
    ...
    try:
        df = pd.read_excel(f'/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/levante/{giocatore}/{nome_file_excel}')
