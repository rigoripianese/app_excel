...
squadra_df = pd.read_csv('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/legnago/squadra.csv')
...
giocatori_df = pd.read_csv('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/legnago/giocatori.csv')
players_html = ""
...
for _, row in giocatori_df.iterrows():
    ...
    try:
        df = pd.read_excel(f'/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/legnago/{giocatore}/{nome_file_excel}')
