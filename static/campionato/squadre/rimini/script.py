...
squadra_df = pd.read_csv('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/rimini/squadra.csv')
...
giocatori_df = pd.read_csv('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/rimini/giocatori.csv')
players_html = ""
...
for _, row in giocatori_df.iterrows():
    ...
    try:
        df = pd.read_excel(f'/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/rimini/{giocatore}/{nome_file_excel}')
    ...
    with open(f'campionato/squadre/{nome_squadra}/{giocatore}/{giocatore}.html', "r") as file:
