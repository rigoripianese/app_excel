...
df = pd.read_excel('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/pescara/merola/rigori_merola.xlsx')
...
with open("campionato/squadre/pescara/merola/merola.html", "r") as file:
...
with open("campionato/squadre/pescara/merola/merola.html", "w") as file:
