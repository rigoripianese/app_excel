...
with open('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/milan/giocatori.txt', 'r') as f:
...
for giocatore in giocatori:
    ...
    try:
        df = pd.read_excel(f'/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/milan/{giocatore}/{nome_file_excel}')
