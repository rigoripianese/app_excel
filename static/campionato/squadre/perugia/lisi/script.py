...
df = pd.read_excel('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/perugia/lisi/rigori_lisi.xlsx')
...
with open("campionato/squadre/perugia/lisi/lisi.html", "r") as file:
...
with open("campionato/squadre/perugia/lisi/lisi.html", "w") as file:
