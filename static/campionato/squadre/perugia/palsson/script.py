...
df = pd.read_excel('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/perugia/palsson/rigori_palsson.xlsx')
...
with open("campionato/squadre/perugia/palsson/palsson.html", "r") as file:
...
with open("campionato/squadre/perugia/palsson/palsson.html", "w") as file:
