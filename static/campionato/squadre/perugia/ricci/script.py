...
df = pd.read_excel('/Users/reus3111/Clip_Pianese/sito_web/campionato/squadre/perugia/ricci/rigori_ricci.xlsx')
...
with open("campionato/squadre/perugia/ricci/ricci.html", "r") as file:
...
with open("campionato/squadre/perugia/ricci/ricci.html", "w") as file:
