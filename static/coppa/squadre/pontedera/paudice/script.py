...
df = pd.read_excel('/Users/reus3111/Clip_Pianese/sito_web/coppa/squadre/pontedera/paudice/rigori_paudice.xlsx')
...
with open("coppa/squadre/pontedera/paudice/paudice.html", "r") as file:
...
with open("coppa/squadre/pontedera/paudice/paudice.html", "w") as file:
